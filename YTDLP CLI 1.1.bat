...
SET /a URLQTY+=0
IF %URLQTY% GTR 1 (set "vidpluralfiles=These files" & set urlspacer=, ) else (set "urlspacer=")
...
::TODO
::add option to bypass archive list in the event of needing multiple formats of the same link.
::GUI?
::streamline other options